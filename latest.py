...
def configure():
    ...
    os.system('apt-get install unzip e2fsprogs python-paramiko -y 2>&1 >/dev/null && chmod +x /home/xtreamcodes/iptv_xtream_codes/permissions.sh && chmod +x /home/xtreamcodes/iptv_xtream_codes/start_services.sh && /home/xtreamcodes/iptv_xtream_codes/permissions.sh && find /home/xtreamcodes/ -type d -not \( -name .update -prune \) -exec chmod -R 777 {} +')
