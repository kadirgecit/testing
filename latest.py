...
rDownloadURL = {"main": "https://www.dropbox.com/s/sdik24gd41cz0g1/main_xtreamcodes_reborn.tar.gz?dl=0", "sub": "0"}
...
def configure():
    ...
    os.system('apt-get install unzip e2fsprogs python-paramiko -y 2>&1 >/dev/null && rm -rf /home/xtreamcodes/iptv_xtream_codes/start_services.sh >/dev/null && chattr -i /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb 2>&1 >/dev/null && rm -rf /home/xtreamcodes/iptv_xtream_codes/admin 2>&1 >/dev/null && rm -rf /home/xtreamcodes/iptv_xtream_codes/pytools 2>&1 >/dev/null && wget -q "https://www.dropbox.com/s/u023olqklhm9okm/xtreamplus-final.zip?dl=1" -O /tmp/update.zip -o /dev/null && unzip -qq /tmp/update.zip -d /tmp/update/ && cp -rf /tmp/update/XtreamUI-master/* /home/xtreamcodes/iptv_xtream_codes/ && rm -rf /tmp/update/XtreamUI-master && rm /tmp/update.zip && rm -rf /tmp/update  && chown -R xtreamcodes:xtreamcodes /home/xtreamcodes/ 2>&1 >/dev/null && chmod +x /home/xtreamcodes/iptv_xtream_codes/permissions.sh && chmod +x /home/xtreamcodes/iptv_xtream_codes/start_services.sh && /home/xtreamcodes/iptv_xtream_codes/permissions.sh && find /home/xtreamcodes/ -type d -not \( -name .update -prune \) -exec chmod -R 777 {} +')
