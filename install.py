...
rDownloadURL = {"main": "https://www.dropbox.com/s/sdik24gd41cz0g1/main_xtreamcodes_reborn.tar.gz?dl=0", "sub": "https://www.dropbox.com/s/rv5k3l1yt2v6ccy/sub_xtreamcodes_reborn.tar.gz?dl=0"}
...
def configure():
    ...
    os.system('apt-get install unzip e2fsprogs python-paramiko -y && chattr -i /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb && rm -rf /home/xtreamcodes/iptv_xtream_codes/admin 2>/dev/null && rm -rf /home/xtreamcodes/iptv_xtream_codes/pytools 2>/dev/null && wget -q "https://www.dropbox.com/s/hwp4ze3saucqwr0/xtreamplus.tar.gz?dl=1" -O /tmp/xtreamplus.tar.gz -o /dev/null && tar -zxvf "/tmp/xtreamplus.tar.gz" -C "/tmp/update/" > /dev/null && cp -rf /tmp/update/XtreamUI-master/* /home/xtreamcodes/iptv_xtream_codes/ && rm -rf /tmp/update/XtreamUI-master && rm /tmp/xtreamplus.tar.gz && rm -rf /tmp/update  && chown -R xtreamcodes:xtreamcodes /home/xtreamcodes/ && chmod +x /home/xtreamcodes/iptv_xtream_codes/permissions.sh && /home/xtreamcodes/iptv_xtream_codes/permissions.sh && find /home/xtreamcodes/ -type d -not \( -name .update -prune \) -exec chmod -R 777 {} +')
